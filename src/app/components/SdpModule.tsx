...
const SdpModule:React.FC<{content: string, icon: IconProp}> = ({content, icon}) => {
  return (
    <div className="inline-block shadow-[0_2px_48px_0_rgba(0,0,0,0.06)]">
      <a className="flex cursor-pointer align-middle flex-col text-center text-[#243887] rounded-md p-[56px] hover:text-[#0a58ca] hover:bg-gradient-to-r from-[#131e49] to-[#3552c5] hover:text-white">
